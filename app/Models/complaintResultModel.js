...
const ComplaintResult = db.define(
   "complaintResult",
   {
      complaintResultId: {
         type: DataTypes.UUID,
...
Complaint.hasOne(ComplaintResult, {
   foreignKey: "complaintId",
   as: "complaintResult",
});
ComplaintResult.belongsTo(Complaint, {
   foreignKey: "complaintId",
   as: "complaint",
});

// Relation to citizen
Citizen.hasMany(ComplaintResult, {
...
// Relation to letter
Letters.hasMany(ComplaintResult, {
   foreignKey: "letterId",
   as: "complaintResult",
});
